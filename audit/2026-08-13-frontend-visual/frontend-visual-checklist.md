...
- Replaced the nine realm medallions with 1254px HD engraved artwork and transparent chroma-key cutouts. The source square canvas is gone; each coin now fills its circular control without a black halo, and the visible medallions are eagerly preloaded to prevent first-render pop-in.
