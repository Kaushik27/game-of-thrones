...
export default function DashboardPage() {
  const { data, loading, error } = useResource(signal => getStatistics(signal), []);
  const stats = data ? [
