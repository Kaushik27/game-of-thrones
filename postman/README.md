...
3. Start the API with `npm run enterprise:api` (or run the production container) and send the requests under **Health & discovery**, **Archive API**, or **Database Explorer**.
